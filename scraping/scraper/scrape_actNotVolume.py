...
# ==========================================
# 1. ACT NOT IN VOLUME (PAGES 2-4) CONFIG
# ==========================================
CATEGORY_URL = "https://lawcommission.gov.np/category/2166/"
TARGET_PAGES = [1, 2]
BASE_URL = "https://lawcommission.gov.np"
SAVE_DIR = "data/raw_pdfs/np/Act_Not_In_Volume"
...
# ==========================================
# 3. SCRAPE ACT NOT IN VOLUME
# ==========================================
def scrape_act_not_in_volume_pages():
    extracted_items = []

    for page_num in TARGET_PAGES:
        page_url = f"{CATEGORY_URL}?page={page_num}"
        print(f"Fetching Act Not In Volume Page {page_num}: {page_url}")
        ...
        for tr in table_rows:
            ...
            if not title:
                title = f"Act_Not_In_Volume_Page{page_num}"
    ...
    for item in tqdm(extracted_items, desc="Downloading Act Not In Volume PDFs"):
...
if __name__ == "__main__":
    scrape_act_not_in_volume_pages()
